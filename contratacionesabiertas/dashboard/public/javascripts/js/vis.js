...
BubbleChart = (function() {
    function BubbleChart(data) {
        ...
        this.create_nodes();
        this.create_vis();
        this.circles.style("fill", '#3a95ff');
    }
    var nodeColors;
    ...
    BubbleChart.prototype.create_vis = function() {
        ...
        this.vis = d3.select("#vis").append("svg").attr("id", "svg_vis").attr("preserveAspectRatio", "xMinYMin meet").attr("viewBox", "-330 -400 2600 1450");
    ...
    BubbleChart.prototype.get_color_map_lookup_set = function(allValuesArray) {
        ...
        baseArray = [
            '#09b109',  // Compra menor
            '#00cc99',  // Licitación por convenio marco
            '#ffcc00',  // Licitacion pública  
               'gray', 	// Licitación pública por mejor valor
            '#663399',  // Procedimiento especial
            '#ff6600',  // Procedimiento excepcional      			
            '#ff008c',  // Subasta en reversa
            '#00BFFF',  // Subasta de bienes públicos
            '#ff6666',
            "#0000D9",
            "#FF00FF",
            "#FF0033",
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
		...
		if (data.original['Proveedor'] !== null) {
		 	content = "<b>Nombre del contrato:</b><br>"+data.original['Producto o servicio']+ 
				 	  "<b><br>Monto USD:</b><br>"+data.original['Monto']+ 
